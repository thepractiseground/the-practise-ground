...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "free language test online", "CEFR level test",
    "free spanish grammar test", "free french grammar test",
    "free german grammar test", "free english grammar test",
    "A1 language test", "B1 language test", "C1 language test",
    "learn spanish online free", "learn french online free",
    "learn german online free", "ESL grammar practice",
    "DELE prep quiz", "DELF prep quiz", "Goethe-Zertifikat practice",
