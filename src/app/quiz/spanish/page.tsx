    ...
    <div className="bg-theme-gradient min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        ...
        <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
          The Common European Framework of Reference for Languages (CEFR) divides language ability into six levels. Our Spanish quizzes cover A1, B1, and C1, with more levels coming soon.
        </p>
