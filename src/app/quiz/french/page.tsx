...
import { FRENCH_CEFR_LEVELS, FRENCH_LEVEL_INFO, getFrenchLevelWeeks } from "@/lib/cefr-french-quiz-data";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.thepractiseground.in/quiz/french",
  },
};

const cefrScale = [
  { level: "A1", name: "Beginner", available: true, key: "a1" },
  { level: "A2", name: "Elementary", available: false },
  { level: "B1", name: "Intermediate", available: true, key: "b1" },
  { level: "B2", name: "Upper Intermediate", available: false },
  { level: "C1", name: "Advanced", available: true, key: "c1" },
  { level: "C2", name: "Proficiency", available: false },
];

export default function FrenchLevelLandingPage() {
  return (
    <div className="bg-theme-gradient min-h-screen">
      ...
      <section className="relative overflow-hidden py-16 sm:py-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-3xl sm:text-5xl font-bold text-white mb-4">
            🇫🇷 French Level Quizzes
          </h1>
          <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-4">
            Practice French grammar at your level. Quizzes organised by CEFR proficiency framework — from Beginner to Advanced.
          </p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        ...
        <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
          The Common European Framework of Reference for Languages (CEFR) divides language ability into six levels. Our French quizzes cover A1, B1, and C1, with more levels coming soon.
        </p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: "🌍", title: "International Students", desc: "Preparing for DELF, DALF, TCF, or other French exams aligned with CEFR levels" },
            { icon: "📚", title: "French Learners", desc: "Students learning French as a second or foreign language at any age" },
            { icon: "🎓", title: "Self-Study Learners", desc: "Anyone wanting to assess and improve their French grammar level independently" },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CollectionPage",
            name: "French Level Quizzes (CEFR) - The Practise Ground",
            description:
              "Free French grammar quizzes organised by CEFR proficiency level. 1,950+ questions across A1 Beginner, B1 Intermediate, and C1 Advanced.",
            url: "https://www.thepractiseground.in/quiz/french",
            provider: {
              "@type": "Organization",
