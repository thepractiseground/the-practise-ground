...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "grade 5 to 10 maths questions",
    "algebra quiz",
    "geometry quiz",
    "trigonometry quiz",
  ],
  alternates: { canonical: "https://www.thepractiseground.in/quiz/maths" },
};

export default function MathsLandingPage() {
  const totalQuestions = MATHS_GRADES.reduce((sum, g) => {
    const weeks = getMathsGradeWeeks(g);
    return sum + weeks.reduce((s, w) => s + w.questions.length, 0);
  }, 0);

  const totalWeeks = MATHS_GRADES.reduce((sum, g) => {
    return sum + getMathsGradeWeeks(g).length;
  }, 0);
    ...
    <div className="bg-theme-gradient min-h-screen">
      ...
      <section className="bg-gradient-to-r from-emerald-600 to-teal-600 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <nav className="text-white/70 text-sm mb-4">
            ...
            <span className="text-white">Maths Quizzes</span>
          </nav>
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-2">
            Free interactive Maths quizzes for Grades 5 to 10. Practice arithmetic, algebra, geometry, trigonometry and more!
          </p>
          <p className="text-white/70">
            {totalQuestions.toLocaleString()}+ questions &middot; {MATHS_GRADES.length} grades &middot; {totalWeeks} weeks of content
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-brand-navy text-center mb-12">Why Practise Maths With Us?</h2>
      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl font-bold text-brand-navy mb-4">Free Online Maths Practice for Indian Students</h2>
          <p className="text-gray-600 mb-4">
            The Practise Ground offers free Maths quizzes for students in Grades 5 through 10. Each quiz features multiple-choice questions covering key topics from the Indian school curriculum — from basic arithmetic and fractions in Grade 5, to quadratic equations and trigonometry in Grade 10.
          </p>
          <p className="text-gray-600 mb-4">
            Our quizzes are designed to supplement classroom learning and help students build confidence through regular practice. Whether you are preparing for school exams, competitive tests, or simply want to sharpen your maths skills, our weekly quizzes provide structured practice at every level.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CollectionPage",
            name: "Maths Quizzes - The Practise Ground",
            description: "Free interactive Maths quizzes for Grades 5 to 10",
            url: "https://www.thepractiseground.in/quiz/maths",
            provider: {
              "@type": "Organization",
