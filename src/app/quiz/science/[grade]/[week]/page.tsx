...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Grade ${grade} Week ${weekNum}: ${topic} - Science Quiz | The Practise Ground`,
    description: `Take this free Grade ${grade} Science quiz on ${topic}. ${weekData.questions.length} multiple-choice questions with instant scoring. Perfect for students aged ${SCIENCE_GRADE_INFO[grade]?.ageRange}.`,
    keywords: [
