...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const enrichment = getQuizEnrichment("english", grade, weekNum);
  const metaDesc = enrichment
    ...
    : `Take this free Grade ${grade} English quiz on ${topic}. ${weekData.questions.length} multiple-choice questions with instant scoring and explanations. Perfect for students aged ${GRADE_INFO[grade]?.ageRange}.`;
  return {
    title: `${topic} Quiz – Grade ${grade} English Practice`,
...
export default async function QuizPage({ params }: Props) {
  ...
  return (
    <div className="bg-theme-gradient min-h-screen pb-16">
      ...
      <RelatedGuides subject="english" seed={weekNum} />
